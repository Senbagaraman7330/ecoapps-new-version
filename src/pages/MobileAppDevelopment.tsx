...
import { mobileAppSchema } from '../data/schemas';
import Header from '../components/Header';
import Footer from '../components/Footer';

gsap.registerPlugin(ScrollTrigger);

// Mobile App Development Subcomponents
import MobileAppHero from '../components/mobile-app/MobileAppHero';
import MobileAppStatsSection from '../components/mobile-app/MobileAppStatsSection';
import MobileAppBentoSection from '../components/mobile-app/MobileAppBentoSection';
import MobileAppServicesSection from '../components/mobile-app/MobileAppServicesSection';
import MobileAppProcessSection from '../components/mobile-app/MobileAppProcessSection';
import MobileAppCtaSection from '../components/mobile-app/MobileAppCtaSection';
...
export default function MobileAppDevelopment() {
  ...
  return (
    <div className="seo-page-root relative w-full min-h-screen bg-white text-[#0b1528] selection:bg-[#0284c7] selection:text-white font-['Manrope'] overflow-x-hidden">
      ...
      <SEO
        title="Build Powerful Apps with best Mobile App Development Company"
        ...
        canonical="https://ecoappssolutions.com/mobile-app-development"
      ...
      <main>
        ...
        <MobileAppHero onHover={handleCursorHover} onLeave={handleCursorLeave} />

        {/* 2. Custom Mobile App Development & Metrics */}
        <MobileAppStatsSection />

        {/* 3. Why Choose Eco Apps Solutions - Bento Architecture & Live Animation Showcase */}
        <MobileAppBentoSection onHover={handleCursorHover} onLeave={handleCursorLeave} />

        {/* 4. Dark Canvas Services Section with Curved Transitions & 3D Tilt Cards */}
        <MobileAppServicesSection onHover={handleCursorHover} onLeave={handleCursorLeave} />

        {/* 5. 6-Step Mobile App Development Methodology Process */}
        <MobileAppProcessSection onHover={handleCursorHover} onLeave={handleCursorLeave} />

        {/* 6. Final Call To Action Banner */}
        <MobileAppCtaSection onHover={handleCursorHover} onLeave={handleCursorLeave} />
      </main>
