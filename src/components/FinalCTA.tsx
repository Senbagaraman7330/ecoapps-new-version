...
export default function FinalCTA({ onHover, onLeave }: FinalCTAProps) {
  return (
    <section className="final-cta px-6 md:px-14 pt-20 pb-28 text-center bg-white" id="contact">
      <div className="final-cta-card max-w-[1100px] mx-auto px-8 md:px-16 py-20 rounded-[48px] bg-gradient-to-br from-[#0b1528] to-[#030712] text-white relative overflow-hidden border border-sky-400/25 shadow-2xl">
        ...
        <h2 className="final-cta-h2 final-cta-h2-reveal font-['Plus_Jakarta_Sans'] font-extrabold text-[clamp(36px,5vw,70px)] leading-[1.08] tracking-[-0.035em] text-white mb-7 relative z-10 max-w-4xl mx-auto">
          Ready to Build Your Next Stage of Growth?
        </h2>

        <p className="font-['Manrope'] text-[17px] md:text-[18px] leading-relaxed text-white/80 max-w-[680px] mx-auto mb-10 relative z-10">
        ...
        <a
          ...
          className="cta-btn inline-flex items-center gap-3.5 px-9 py-4 font-['Manrope'] text-[15px] font-extrabold text-[#030712] bg-gradient-to-b from-sky-300 to-sky-500 rounded-2xl shadow-[0_12px_24px_rgba(14,165,233,0.5)] hover:shadow-[0_16px_32px_rgba(14,165,233,0.6)] hover:-translate-y-1 transition-all duration-300 relative z-10"
