...
const WEB_STATS: WebDevStatItem[] = [
  {
    num: 100,
    decimals: 0,
    suffix: '%',
    label: 'Mobile-Friendly & Responsive Layouts',
  },
  {
    num: 99.9,
    decimals: 1,
    suffix: '%',
    label: 'Fast-Loading Performance Optimization',
  },
  {
    num: 100,
    decimals: 0,
    suffix: '%',
    label: 'SEO-Ready Semantic Architecture',
  },
  {
    num: 24,
    decimals: 0,
    suffix: '/7',
    label: 'Scalable & Secure Digital Reliability',
  },
];

export default function WebDevStatsSection() {
  ...
  return (
    <section
      ...
      id="web-stats"
    >
      {/* Ambient background glow matching SeoStatsSection */}
      ...
      <div className="relative z-10">
        <div className="max-w-5xl mx-auto text-center mb-12 md:mb-14">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-sky-100 border border-sky-200 text-[#0284c7] text-[11px] font-['JetBrains_Mono'] font-bold tracking-wider mb-3.5 uppercase shadow-2xs">
            <span>Why Choose Eco Apps Solutions for Website Development?</span>
          </div>
