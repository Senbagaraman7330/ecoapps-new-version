...
export default function WebDevHero({ onHover, onLeave }: WebDevHeroProps) {
  ...
  const currentTile =
    DESKTOP_SOFTWARE_TILES.find((t) => t.id === 'website-development') || DESKTOP_SOFTWARE_TILES[1];

  return (
    <section
      ref={heroRef}
      className="ls-seo-hero"
      aria-label="Website Development Services Hero"
