...
export default function EcommerceHero({ onHover, onLeave }: EcommerceHeroProps) {
  ...
  const currentTile =
    DESKTOP_MARKETING_TILES.find((t) => t.id === 'ecommerce') || DESKTOP_MARKETING_TILES[1];

  return (
    <section
      ref={heroRef}
      className="ls-seo-hero"
      aria-label="Ecommerce Marketing Services Hero"
