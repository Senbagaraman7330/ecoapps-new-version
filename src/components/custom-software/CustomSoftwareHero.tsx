...
interface CustomSoftwareHeroProps {
...
export default function CustomSoftwareHero({
  defaultServiceId = 'custom-developments',
  onHover,
  onLeave,
}: CustomSoftwareHeroProps) {
  ...
  const currentTile =
    DESKTOP_SOFTWARE_TILES.find((t) => t.id === defaultServiceId) || DESKTOP_SOFTWARE_TILES[4];

  return (
    <section
      ref={heroRef}
      className="ls-seo-hero"
      aria-label="Custom Software Development Hero"
