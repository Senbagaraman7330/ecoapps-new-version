...
export default function Hero({
  ...
  return (
    <main className="hero grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-10 px-6 md:px-14 py-12 md:py-14 items-center relative z-10 min-h-[720px]">
      <div className="hero-left pt-2">
