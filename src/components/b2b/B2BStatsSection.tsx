...
const B2B_STATS: B2BStatItem[] = [
  {
    num: 4.4,
    decimals: 1,
    suffix: '×',
    label: 'Average Pipeline Value Growth',
  },
  {
    num: 89,
    decimals: 0,
    suffix: '%',
    label: 'Target Account Decision-Maker Reach',
  },
  {
    num: 65,
    decimals: 0,
  ...
  },
  {
    ...
    decimals: 0,
    suffix: '%',
    label: 'Client Pipeline Retention Rate',
  },
];

export default function B2BStatsSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[650px] h-[260px] bg-gradient-to-b from-sky-50/70 to-transparent blur-3xl pointer-events-none" />

      {/* Performance & Measurable Outcomes Block */}
      <div className="relative z-10">
        <div className="max-w-5xl mx-auto text-center mb-12 md:mb-14">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-sky-50 border border-sky-200 text-[#0284c7] text-[11px] font-['JetBrains_Mono'] font-bold tracking-wider mb-3.5 uppercase shadow-2xs">
          ...
          <h2 className="section-title-reveal font-['Plus_Jakarta_Sans'] font-extrabold text-[clamp(28px,3.4vw,44px)] text-[#0b1528] leading-[1.12] tracking-tight mb-4">
            B2B Growth Engineered for Decision-Maker Influence
          </h2>
          <p className="font-['Manrope'] text-[15px] sm:text-[16.5px] leading-[1.68] text-slate-600 max-w-3xl mx-auto">
            At Eco Apps Solutions, we combine SEO, high-intent paid advertising, LinkedIn thought leadership, demand generation, and Account-Based Marketing (ABM) to create a sustainable pipeline of high-value client contracts.
          </p>
        </div>
