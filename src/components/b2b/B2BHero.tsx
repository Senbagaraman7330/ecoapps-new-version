...
export default function B2BHero({ onHover, onLeave }: B2BHeroProps) {
  ...
  const currentTile =
    DESKTOP_MARKETING_TILES.find((t) => t.id === 'b2b-performance') || DESKTOP_MARKETING_TILES[3];

  return (
    <section
      ref={heroRef}
      className="ls-seo-hero"
      aria-label="B2B Performance Marketing Services Hero"
